...
transcript now has such a fallback:
  ...
  gender / role ................. extract_pass               (suggested_gender / _role)
  ...
  age / DOB ownership ........... pii_owner_pass             (specific owner + ATTRIBUTE_OF edge)
...
Public API:
  ...
  pii_owner_pass               -- use #6: age / DOB ownership (pii_owner.py)
                                   (which person an age / birth date belongs to)
"""
...
from .pii_owner import pii_owner_pass
