...
# words we strip before comparing name strings; used later elsewhere
KINSHIP_AND_TITLES = {
    "aunt", "uncle", "mother", "father", "mom", "dad", "grandma", "grandpa",
    "grandmother", "grandfather", "cousin", "sister", "brother", "husband",
    "wife", "son", "daughter", "niece", "nephew",
    "mr", "mr.", "mrs", "mrs.", "ms", "ms.", "miss", "dr", "dr.",
    "my", "his", "her", "their", "our",
}


# nickname map; can also import from csv
NICKNAMES = {
    "mar": "maria",
    ...
    "mike": "michael", "tony": "anthony", "chris": "christopher",
    "jen": "jennifer", "jenny": "jennifer",
    "dee": "denise", "trey": "trey",
}
